...
import kysuHoTro from "@/assets/ky-su-ho-tro-giai-doan-dau.webp";
import dongHanh from "@/assets/dong-hanh-cung-nha-may.webp";
import congTrinhSonGo from "@/assets/cong-trinh-son-go-ngoai-troi-lotus.webp";
import nhaMayDonHang from "@/assets/nha-may-don-hang-xk.webp";
import thuMauTruocLo from "@/assets/thu-mau-truoc-khi-vao-lo.webp";
import hoTroKyThuat from "@/assets/ho-tro-ky-thuat-tai-xuong.webp";
import cungUngTienDo from "@/assets/cung-ung-theo-doi-tien-do.webp";
import sonAnToanXK from "@/assets/son-an-toan-noi-that-xuat-khau-09.webp";
import heroWood from "@/assets/hero-wood.webp";
import procLau from "@/assets/proc-lau.webp";
import procPhun from "@/assets/proc-phun.webp";
import procMdf from "@/assets/proc-mdf.webp";
import procBong from "@/assets/proc-bong.webp";
import keoTramTret from "@/assets/keo-tram-tret-go-lotus-wood-filler.webp";
import sonLot from "@/assets/son-lot-lap-tim-va-lam-phang-go-lotus-sanding-sealer.webp";
import heGiVan from "@/assets/son-tao-mau-go-va-hoan-thien-go-noi-that-lotus-woodstain-finish-interior.webp";
import heMauBet from "@/assets/son-phu-mau-go-noi-that-lotus-wood-paint-indoor.webp";
import heBaoVeNgoaiThat from "@/assets/son-phu-acrylic-lacquer-ngoai-that-lotus-lacquer-exterior.webp";
import heSon2K from "@/assets/2k- lacquer 2k72 out door-1.webp";
import sonPhunWeb from "@/assets/son-phun-lotus-web.webp";
import sonLauWeb from "@/assets/son-lau-lotus-web.webp";
import mauBetGoTuNhien from "@/assets/mau-bet-go-tu-nhien.webp";
import sonBetMdfLotus from "@/assets/son-bet-mdf-lotus.webp";
...
import nhaMayCasta from "@/assets/nha-may-casta.webp";
import pacificFur from "@/assets/pacific-fur.webp";
import aeonLongan from "@/assets/aeon-longan.webp";
import aeonTanAn from "@/assets/aeon-tan-an.webp";
...
const sampleItemsMap: Record<string, SampleItem[] | { lau: SampleItem[]; phun: SampleItem[] }> = {
  "Hệ Giữ Vân Nội Thất": {
    lau: [
      { name: "Lotus wood stain", price: 205000 },
      { name: "Lotus sanding sealer", price: 160000 },
      { name: "Lotus acrylic lacquer IN", price: 205000 },
    ],
    phun: [
      { name: "Lotus sanding sealer", price: 160000 },
      { name: "Lotus wood stain finish IN", price: 248000 },
    ],
  },
  "Hệ Màu Bệt Nội Thất — Gỗ Tự Nhiên": [
    { name: "Lotus wood primer", price: 160000 },
    { name: "Lotus wood paint IN", price: 254000 },
  ],
  "Hệ Giữ Vân Ngoại Thất": {
    lau: [
      { name: "Lotus wood stain", price: 205000 },
      { name: "Lotus sanding sealer", price: 160000 },
      { name: "Lotus acrylic lacquer EX", price: 237000 },
    ],
    phun: [
      { name: "Lotus sanding sealer", price: 160000 },
      { name: "Lotus woodstain finish exterior", price: 313000 },
    ],
  },
  "Hệ Màu Bệt Ngoại Thất — Gỗ Tự Nhiên": [
    { name: "Lotus wood primer", price: 160000 },
    { name: "Lotus wood paint EX", price: 318000 },
  ],
...
const getSampleItems = (title: string, selectedMethod: "lau" | "phun"): SampleItem[] => {
...
const getSamplePrice = (title: string, selectedMethod: "lau" | "phun"): number => {
...
function FinishFinder({ onInteractionChange }: { onInteractionChange: (interacting: boolean) => void }) {
  ...
  return (
    ...
    {showFullColorChart && coatingSystem && (() => {
      ...
      {/* Modal form đặt mẫu thử */}
      <SampleRequestModal
        isOpen={showSampleForm}
