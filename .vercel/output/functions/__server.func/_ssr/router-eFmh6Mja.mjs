...
const appCss = "/assets/styles-BsUw76cA.css";
...
const Route$1 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Dịch vụ sơn gỗ chuyên nghiệp: nội thất, ngoại thất, đánh dầu, phủ bóng, bảo dưỡng gỗ. Tư vấn & báo giá miễn phí qua Zalo 0943 966 662."
      },
      ...
      },
      {
        ...
        content: "Dịch vụ sơn gỗ chuyên nghiệp. Tư vấn & báo giá miễn phí qua Zalo."
      },
...
const $$splitComponentImporter = () => import("./index-DcSBuWMm.mjs");
const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Bốn quy trình hoàn thiện gỗ Lotus: sơn lau giữ vân, sơn phun nội ngoại thất, màu bệt MDF, phủ bóng ngoài trời. Nhắn Zalo để được tư vấn đúng hệ."
    }]
  })
});
